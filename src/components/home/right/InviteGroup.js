          ...
          <div className="contact hover3">
            <div className="circle_icon_notification">
              <div
                ...
                style={{
                  background: "#F0F2F5", // Nền sáng cho card
                  marginLeft: "10px",
                  padding: "5px", // Thêm padding để làm không gian giữa nội dung và biên
                  marginBottom: "5px", // Khoảng cách dưới mỗi card
                  borderRadius: "5px", // Bo góc cho card
                  cursor: "pointer", // Thêm con trỏ pointer khi di chuột vào
                }}
              >
            ...
            <div
              className="body_requests"
              
            >
              <div
                className="name_requests"
                style={{
                  wordWrap: "break-word", // Đảm bảo chữ dài không bị tràn ra ngoài
              ...
              >
                <p>
                  ...
                  <span style={{ fontWeight: "300" }}>invite you to group</span>
