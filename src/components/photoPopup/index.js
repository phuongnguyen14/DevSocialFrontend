...
import CloseIcon from "@mui/icons-material/Close"; // Nhập biểu tượng đóng
...
export default function PhotoPopup({
  ...
  return (
    <div className="PhotoPopup">
      ...
      >
        {/* Nút đóng ở góc trên bên phải của ảnh */}
        <div
        ...
        >
          <CloseIcon style={{ color: "#fff" }} onClick={goOut} />{" "}
          {/* Biểu tượng đóng */}
        </div>
        <div
